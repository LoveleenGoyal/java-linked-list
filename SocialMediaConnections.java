public class SocialMediaConnections {
    ...
    public static void main(String[] args) {
        ...
        smc.addUser("U101", "Alice", 25);
        smc.addUser("U102", "Bob", 28);
        smc.addUser("U103", "Charlie", 22);

        smc.addFriend("U101", "U102");
        smc.addFriend("U101", "U103");

        smc.displayFriends("U101");
        smc.countFriends("U101");

        smc.findMutualFriends("U101", "U102");

        smc.removeFriend("U101", "U103");
        smc.displayFriends("U101");
    }
}
